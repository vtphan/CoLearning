...
def workspace(student_id, problem_id):
        ...
        problem, workspace, submissions = get_workspace_info(student_id, problem_id)
        ...
        return dict(problem=problem, workspace=workspace, time_interval=1000, submissions=submissions, student_name=student_name, student_id=student_id, help_form=help_form)
...
def workspace_view(student_id, problem_id):
        ...
        return dict(problem=problem, workspace=workspace, time_interval=1000, submissions=submissions, student_name=student_name, student_id=student_id)
...
def get_workspace_info(student_id, problem_id):
        ...
        return problem, workspace, submissions